...
The predefined text searched for in #2 should be unlikely to change by content modifications and also be unlikely to exist in possible error messages issued by the HTTP server.
